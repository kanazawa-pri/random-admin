...
def regist_article(mysql,site_name,article_reporter,article_url,text,article_title,article_image):
    ...
    if article_id == 1:
        ("同じ内容の記事がすでに登録されています。")
        return
    mysql.regist_article(article_id,site_name,article_reporter,article_url,top_word_list,article_title,article_image)
